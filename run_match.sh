...
# ---------- Defaults ----------
ENGINE_A_BIN="./versions/chess_v1"
ENGINE_A_ARG="uci"
ENGINE_A_NAME=""  # will auto-default to basename of ENGINE_A_BIN

ENGINE_B_BIN="./versions/chess_v2"
ENGINE_B_ARG="uci"
ENGINE_B_NAME=""  # will auto-default to basename of ENGINE_B_BIN
...
if [[ -n "$OPENINGS_FILE" ]]; then
  ...
  CMD+=( -openings file="$OPENINGS_FILE" format="$OPENINGS_FORMAT" order="$OPENINGS_ORDER" )
