// Piece-Square Tables from Stockfish, adapted for this engine's piece indexing.
// The tables for black pieces are generated by mirroring the white piece tables.
// Indexing: [Piece::index()][square]

pub const MG_PST: [[i32; 64]; 13] = [
    // Empty (0)
    [0; 64],
    // WP (1)
    [
    ...
    // BK (12)
    [
        -15, 36, 12, -54, 8, -28, 24, 14, 1, 7, -8, -64, -43, -16, 9, 8, -14, -14, -22, -46, -44,
...
pub const EG_PST: [[i32; 64]; 13] = [
    ...
    // WB (3)
    [
        -14, -21, -11, -8, -7, -9, -17, -24, -8, 7, -1, -2, 3, -3, 2, -15, -2, 4, 1, 4, 7, 4, 0,
        -5, -3, 10, 12, 12, 8, 7, 6, -3, -6, 11, 13, 13, 7, 7, 4, -3, -1, 3, 5, 5, 5, 2, 2, -8, -2,
        4, 8, 1, 7, 1, -3, -13, -29, -17, -4, -4, -5, -12, -12, -28,
    ],
    // WR (4)
    [
    ...
    [
        ...
        21, 23, 16, 7, -9, -27, -11, 4, 13, 15, -3, -11, -19, -53, -34, -21, -11, -28, -14, -24,
        -43,
    ],
    // BP (7)
    [
    ...
    // BB (9)
    [
        -29, -17, -4, -4, -5, -12, -12, -28, -2, 4, 8, 1, 7, 1, -3, -13, -1, 3, 5, 5, 5, 2, 2, -8,
        -6, 11, 13, 13, 7, 7, 4, -3, -3, 10, 12, 12, 8, 7, 6, -3, -2, 4, 1, 4, 7, 4, 0, -5, -8, 7,
        -1, -2, 3, -3, 2, -15, -14, -21, -11, -8, -7, -9, -17, -24,
    ],
    // BR (10)
    [
    ...
    // BK (12)
    [
        -53, -34, -21, -11, -28, -14, -24, -43, -27, -11, 4, 13, 15, -3, -11, -19, -19, -3, 11, 21,
